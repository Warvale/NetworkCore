...
import net.warvale.network.utils.Broadcast;
import net.warvale.network.vale.PayCommand;
import net.warvale.network.vale.ValeCommand;
...
public class CommandHandler implements CommandExecutor, TabCompleter {
    ...
    public void registerCommands() {
        ...
        // Admin
        cmds.add(new ValeCommand());
        cmds.add(new ValeItemInInvCommand(plugin));
